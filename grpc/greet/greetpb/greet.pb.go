...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x32, 0x44, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x63, 0x65,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	1, // 1: greet.GreetServece.Greet:input_type -> greet.GreetRequest
	2, // 2: greet.GreetServece.Greet:output_type -> greet.GreetResponse
...
func (c *greetServeceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetServece/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGreetServeceServer can be embedded to have forward compatible implementations.
type UnimplementedGreetServeceServer struct {
}

func (*UnimplementedGreetServeceServer) Greet(context.Context, *GreetRequest) (*GreetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Greet not implemented")
}

func RegisterGreetServeceServer(s *grpc.Server, srv GreetServeceServer) {
	s.RegisterService(&_GreetServece_serviceDesc, srv)
}

func _GreetServece_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServeceServer).Greet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetServece/Greet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServeceServer).Greet(ctx, req.(*GreetRequest))
	}
...
var _GreetServece_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Greet",
			Handler:    _GreetServece_Greet_Handler,
		},
	},
